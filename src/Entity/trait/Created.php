...
trait Created
{
    ...
    public function __construct_created(): void
    {
        ...
        if(!($this instanceof TraitCreatedInterface)) throw new Exception(vsprintf('Error %s line %d: this class %s should implement %s!', [__METHOD__, __LINE__, static::class, TraitCreatedInterface::class]));
