...
{
    public const CONTEXT_AS_MODEL = 'entity_is_model';
    ...
    public function denormalizeEntity(mixed $data, string $type, ?string $format = null, ?array $context = [], ?string $uname = null): WireEntityInterface;
    // Serialize
